...
SAMPLE, = glob_wildcards(config['data']+"/{id}.fastq").id
...
rule SNIPER:
    input:
        ...
        #OUTPUT_VCF=expand("results/PEPPER/{SAMPLE}/PEPPER_HP_VARIANT_FULL.vcf.gz", SAMPLE=SAMPLE),
...
include: "rules/SVM_final_callset.smk"
